...
namespace Stash
{
	public class Example : MonoBehaviour
	{
		...
		public Vector3 debugCapsule_Start = new Vector3(70, 0, 0);
		...
		void Update()
		{
			...
			DebugExtension.DebugCapsule(debugCapsule_Start, debugCapsule_End, debugCapsule_Color, debugCapsule_Radius);
		}
	}
}